...
import 'package:prime/base/buildConfig.dart';
import 'package:prime/network/intercept/base_intercept.dart';
import 'package:prime/utils/entity_utils.dart';
import 'package:prime/network/myIntercept.dart';
  ...
  PublishSubject<T> _requstHttp<T>(String url,
    ...
    future.then((data) {
      ...
      if (isError) {
        ...
        publishSubject
            .add(EntityUtils.generateOBJ<T>(json.decode(data.toString())));
